...
**Domain:** Windows desktop construction takeoff application (PDF markup, canvas, Excel export)
**Researched:** 2026-03-25
**Confidence:** HIGH (core framework and PDF stack), MEDIUM (canvas integration pattern, export)
...
npm create electron-vite@latest clmc-takeoff -- --template react-ts
cd clmc-takeoff
...
**Rendering architecture (PDF behind Konva stage):**
...
---
*Stack research for: CLMC Takeoff App — Windows desktop construction takeoff*
*Researched: 2026-03-25*
