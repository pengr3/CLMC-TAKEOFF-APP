...
| GAP-002 | Gap Re-Audit — What's Lacking After the Precision Update | complete | 2026-06-29 | Vertex-edit/translate/undo/snapping/arcs all CLOSED (Ph 10–14). Center of gravity moved off *drawing* → onto **distribution, pricing, delivery**. Tier 0 = no shipped installer/auto-update (blocker). Spike candidates: 004-installer-smoke, 005-pdf-flatten-arcs, 006-area-cutouts. Rest = build-work. Flagged BACKLOG drift ("pricing+library=Ph14" is false). |
